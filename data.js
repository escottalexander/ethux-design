...
const DATA = {
  categories: [
    ...
    { id:'transaction-clarity', title:'Transaction Clarity', icon:'eye', color:'var(--cat-2)', desc:'Understanding what you\'re signing, approving, and paying for before committing.', problems:[
      ...
      { title:'Blanket Warnings', severity:'medium', status:'unsolved', desc:'Wallets apply identical red warnings to all unlimited token approvals regardless of context.', solutions:[{name:'Contextual risk assessment',status:'Research',adoption:'No standard'},{name:'Reputation-based warnings',status:'Research',adoption:'No standard'}], eips:[], checklist:'safety' }
    ]},
    { id:'cross-chain', title:'Cross-chain & Networks', icon:'chain', color:'var(--cat-3)', desc:'Managing assets, switching networks, and bridging across L1 and L2 chains.', problems:[
      { title:'Fragmented Asset View', severity:'critical', status:'in-progress', desc:'Users must manually switch networks to see their full balances. Portfolio tracking across chains requires cognitive overhead.', solutions:[{name:'Unified balance display',status:'In Progress',adoption:'4/10 wallets'},{name:'EIP-7811 unified balances',status:'Research',adoption:'Draft'},{name:'Chain abstraction',status:'Research',adoption:'Experimental'}], eips:['EIP-7811'], checklist:'multichain' },
      ...
      { title:'Asset Fragmentation', severity:'high', status:'in-progress', desc:'Tokens scattered across chains create artificial friction.', solutions:[{name:'Intent-based protocols',status:'In Progress',adoption:'Growing'},{name:'Interop layer (EIL)',status:'Research',adoption:'Conceptual'}], eips:[], checklist:'multichain' }
    ]},
    { id:'safety', title:'Safety & Security', icon:'shield', color:'var(--cat-4)', desc:'Protecting users from scams, phishing, and irreversible mistakes.', problems:[
    ...
    { id:'mobile', title:'Mobile & Connectivity', icon:'phone', color:'var(--cat-5)', desc:'Connecting wallets, mobile experiences, and device compatibility.', problems:[
      { title:'Connection Failures', severity:'high', status:'in-progress', desc:'When using multiple wallet extensions, it\'s a struggle to select the right one.', solutions:[{name:'EIP-6963 multi-wallet discovery',status:'Live',adoption:'6/10 wallets'},{name:'WalletConnect v2',status:'Live',adoption:'7/10 wallets'}], eips:['EIP-6963'], checklist:'wallets' },
    ...
    { id:'language', title:'Language & Accessibility', icon:'globe', color:'var(--cat-6)', desc:'Making Ethereum understandable and usable for everyone, everywhere.', problems:[
    ...
    { id:'protocol', title:'Protocol Design', icon:'gear', color:'var(--cat-7)', desc:'When protocol-level decisions create unexpected UX challenges for wallets and their users.', problems:[
      { title:'No Default Native Account Abstraction', severity:'high', status:'research', desc:'On Ethereum, EOAs remain the default account type. Users must manage private keys, pay gas in ETH, and approve every action individually. Starknet launched with native AA where every account is a smart contract by default. EIP-7702 bridges EOAs toward smart account behavior but adoption is low. Only MetaMask and Ambire have shipped end-user support. Rabby does not support it. EIP-7701 (full native AA) is a stagnant draft with no scheduled implementation.', solutions:[{name:'EIP-7701 native AA',status:'Research',adoption:'Stagnant draft'},{name:'EIP-7702 as bridge',status:'Live',adoption:'MetaMask, Ambire only'},{name:'ERC-4337 (off-protocol AA)',status:'Live',adoption:'Growing but opt-in'}], eips:['EIP-7701','EIP-7702','ERC-4337'], checklist:null },
...
const CRITICAL_DETAILS = {
  'The Gas Hurdle': {
    ...
    opportunity: '<div class="lead">Eliminating the gas hurdle captures first-time users at their highest-intent moment.</div><ul><li>$2.1B in annual onramp volume lost to abandonment at the ETH acquisition step</li><li>Paymasters and gas sponsorship convert this drop-off into a revenue opportunity</li><li>First wallets to solve this own the onboarding funnel</li></ul>',
  ...
  'Blind Signing': {
    ...
    opportunity: '<div class="lead">Human-readable signing screens differentiate wallets on trust.</div><ul><li>Clear signing could reduce phishing losses estimated at $300M+ annually</li><li>Removes hesitation users feel before every signature, increasing dapp engagement</li><li>Trust-first wallets command premium loyalty and retention</li></ul>',
  ...
  'Fragmented Asset View': {
    ...
    opportunity: '<div class="lead">Unified cross-chain balances eliminate the need for external portfolio trackers.</div><ul><li>Retains user attention within the wallet instead of third-party tools</li><li>Creates natural upsell paths for swaps and bridging</li><li>Table stakes for the multi-chain era</li></ul>',
  ...
  'Bridging Pain': {
    ...
    opportunity: '<div class="lead">Single-click bridging captures cross-chain fees in a $500M+ annual market.</div><ul><li>Intent-based protocols already capturing significant volume by abstracting this pain</li><li>Seamless bridging is a revenue multiplier for every dapp</li><li>First movers own the cross-chain transaction layer</li></ul>',
  ...
  'Mobile Connection Dance': {
    ...
    opportunity: '<div class="lead">Mobile is 60%+ of web traffic. Nailing mobile connection is the biggest competitive differentiator.</div><ul><li>Wallets with smooth mobile flows capture the majority of new user interactions</li><li>Seamless mobile UX unlocks the largest computing platform on Earth</li><li>First movers in mobile own the next generation of crypto users</li></ul>',
    risk: '<div class="lead">Failed mobile connections are the top reason users abandon dapp interactions on phones.</div><ul><li>Every broken flow is a lost transaction and a lost fee</li><li>Users who fail once conclude "crypto doesn\'t work on mobile"</li><li>Permanently lost users rarely give a second chance</li></ul>'
  },
  'Inscrutable Jargon': {
