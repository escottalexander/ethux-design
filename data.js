...
const DATA = {
  categories: [
    ...
    { id:'language', title:'Accessibility', icon:'globe', img:'images/accessibility.svg', color:'var(--cat-6)', hook:'Open the door for 75% of non-English speakers.', desc:'Over 75% of cryptocurrency users are non-native English speakers. Most dapps are English-only, jargon-heavy, and fail basic accessibility standards. This is the largest unaddressed audience in the ecosystem.', problems:[
      ...
      { title:'Conflicting Mental Models', severity:'high', status:'unsolved', desc:'Users arriving from traditional finance expect bank-like concepts: accounts with balances, simple transfers, and customer support. Instead they encounter gas fees, signing prompts, and token approvals. Users arriving from general tech expect app-like patterns: undo, password reset, and human support. None of these exist. Every dapp assumes its users already understand both financial and blockchain mechanics, when in reality most understand neither.', solutions:[{name:'Progressive disclosure patterns',status:'Research',adoption:'Limited'},{name:'Contextual education',status:'Building',adoption:'Few dapps'}], eips:[], checklist:'onboarding' },
