...
const DATA = {
  categories: [
    ...
    { id:'safety', title:'Safety & Security', icon:'shield', color:'var(--cat-4)', desc:'Protecting users from scams, phishing, and irreversible mistakes. Solutions should empower user agency with transparent, controllable defenses rather than opaque restrictions users never opted into.', problems:[
